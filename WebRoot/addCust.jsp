		...
		<div style="margin-bottom:5px;margin:20px;">
			<s:form name="userForm" method="post" class="form-x"
				...
				<div class="form-group">
					...
					<div class="field">
							<s:textfield id="address" name="address" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="contact" name="contact" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="contactPhone" name="contactPhone" type="text"
							cssClass="input input-big"
							 />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="custMgr" name="custMgr" type="text"
							cssClass="input input-big"
							 />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="custMgrPhone" name="custMgrPhone" type="text"
							cssClass="input input-big"
							 />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="field">
						<s:select cssClass="input input-big " 
							...
							headerKey="" id="status" name="status">

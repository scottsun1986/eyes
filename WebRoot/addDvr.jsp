		...
		<div style="margin-bottom:5px;margin:20px;">
			<s:form name="userForm" method="post" class="form-x"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input  input-big" id="username" name="username" data-validate="required:不为空"
							size="20"  onclick="openChooseDialog()"   placeholder="点击输入框选择用户接入点" />
					
						<s:hidden id="custId" name="custId"/>
					</div>
				</div>
				<div class="form-group">
					<div class="label">
					...
					<div class="field">
							<s:textfield id="puName" name="puName" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:select cssClass="input input-big " 
							...
							headerKey="" id="platformType" name="platformType">
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="platformAccount" name="platformAccount" type="text"
							cssClass="input input-big"
							 />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="bandSpeed" name="bandSpeed" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:select cssClass="input input-big " 
							...
							headerKey="" id="bandMode" name="bandMode">
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="bandDevice" name="bandDevice" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="bandPort" name="bandPort" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="ip" name="ip" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="dvr" name="dvr" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="diskSize" name="diskSize" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="diskType" name="diskType" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="dvrAddress" name="dvrAddress" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="cameraType" name="cameraType" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="cameraNum" data-validate="plusinteger:请输入数字" name="cameraNum" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="cameraDesc" name="cameraDesc" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:textfield id="cameraDvrLength" name="cameraDvrLength" type="text"
				...
				<div class="form-group">
					...
					<div class="field">
						<s:select cssClass="input input-big " 
							...
							headerKey="" id="propertyRight" name="propertyRight">

						</s:select>
					</div>
				</div>
				<button id="submitbtn" class="button  icon-plus">添加</button>
			</s:form>

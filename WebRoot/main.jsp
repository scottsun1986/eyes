		...
		<div    style="margin-bottom:5px;margin:20px;">
			<table class="table table-condensed table-striped table-bordered">
				...
				<tr>
					...
					<td><button class="button button-little " onclick="window.open('gotoDvrDetailPage.action?id=<%=currentDvr.getId()%>')">详情</button><button class="button button-little">修改</button><button class="button button-little">删除</button></td>
				</tr>
				<%
					}
					}
